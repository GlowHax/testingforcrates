...
public class CrateOpeningManager : MonoBehaviour
{
	...
	[HideInInspector] public List<CrateBehaviour> UnopenedCrates = new List<CrateBehaviour>();
	...
	private void CheckSimpleCombo()
	{
		...
		{
			Player.Instance.ComboBonus += 0.01f; // +1%
